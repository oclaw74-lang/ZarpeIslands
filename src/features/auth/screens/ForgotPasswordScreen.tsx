...
import { requestPasswordReset } from '@/features/auth/api/authService';
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={styles.card}>
            ...
            {sent ? (
              <ThemedText testID="forgot-password-success" type="small" style={styles.centeredBody}>
              ...
              <>
                ...
                {error.length > 0 && (
                  <ThemedText testID="forgot-password-error" type="small" style={styles.error}>
                    {error}
                  </ThemedText>
                )}
            ...
            <Pressable testID="forgot-password-back" onPress={() => router.replace('/login')}>
